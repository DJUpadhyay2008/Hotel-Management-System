...
const menu_variant_entity_1 = require("../../menu-items/entities/menu-variant.entity");
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => menu_variant_entity_1.MenuVariant, { nullable: true }),
    (0, typeorm_1.JoinColumn)({ name: 'variantId' }),
    __metadata("design:type", menu_variant_entity_1.MenuVariant)
